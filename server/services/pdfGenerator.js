...
<div style="margin:14px 0;">
  ...
  <svg viewBox="0 0 780 820" style="width:100%;max-width:680px;display:block;margin:0 auto;border-radius:10px;border:1px solid #e8e4d9;">
    <!-- Background -->
    <rect width="780" height="820" fill="#f0f4f8"/>

    <!-- NORTH AFRICA — Purple #7b3fa0 -->
    <!-- Morocco -->
    <polygon points="90,85 135,75 155,85 160,115 145,130 110,135 85,120 80,100" fill="#7b3fa0" stroke="white" stroke-width="0.7"/>
    <text x="120" y="108" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Morocco</text>
    <!-- Algeria -->
    <polygon points="155,85 240,75 270,90 275,130 265,155 200,160 160,150 145,130 160,115" fill="#7b3fa0" stroke="white" stroke-width="0.7"/>
    <text x="213" y="120" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Algeria</text>
    <!-- Tunisia -->
    <polygon points="240,75 265,72 275,85 275,100 260,110 245,100 240,88" fill="#7b3fa0" stroke="white" stroke-width="0.7"/>
    <text x="257" y="93" font-size="6" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Tunisia</text>
    <!-- Libya -->
    <polygon points="265,72 340,68 365,80 370,120 355,155 300,160 275,130 275,100 275,85" fill="#7b3fa0" stroke="white" stroke-width="0.7"/>
    <text x="318" y="112" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Libya</text>
    <!-- Egypt -->
    <polygon points="365,80 430,75 450,90 455,130 440,155 385,160 355,155 370,120" fill="#7b3fa0" stroke="white" stroke-width="0.7"/>
    <text x="408" y="115" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Egypt</text>
    <!-- Western Sahara -->
    <polygon points="80,120 110,135 120,155 110,175 80,180 62,160 60,135" fill="#9b5abf" stroke="white" stroke-width="0.7"/>
    <text x="90" y="153" font-size="5.5" fill="white" text-anchor="middle" font-family="Arial">W. Sahara</text>
    <!-- Sudan -->
    <polygon points="440,155 480,145 510,155 515,195 505,230 470,245 440,240 420,215 415,185 430,160" fill="#7b3fa0" stroke="white" stroke-width="0.7"/>
    <text x="465" y="195" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Sudan</text>

    <!-- WEST AFRICA — Gold #c9a84c -->
    <!-- Mauritania -->
    <polygon points="62,160 110,175 120,155 130,175 125,210 90,225 60,220 50,190" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="88" y="193" font-size="6.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Mauritania</text>
    <!-- Mali -->
    <polygon points="130,175 200,160 265,155 270,185 260,225 230,250 195,265 165,265 140,240 125,210" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="198" y="215" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Mali</text>
    <!-- Niger -->
    <polygon points="265,155 355,155 370,175 365,215 345,235 310,245 270,240 260,225 270,185" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="315" y="200" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Niger</text>
    <!-- Senegal & Gambia -->
    <polygon points="60,220 90,225 105,240 100,258 80,265 55,255 48,238" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="78" y="245" font-size="6" fill="white" text-anchor="middle" font-family="Arial">Senegal</text>
    <!-- Guinea -->
    <polygon points="65,268 100,260 120,270 115,292 95,298 68,290" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="92" y="281" font-size="6" fill="white" text-anchor="middle" font-family="Arial">Guinea</text>
    <!-- Sierra Leone & Liberia -->
    <polygon points="68,292 100,300 115,310 108,330 85,335 62,320 58,305" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="85" y="315" font-size="5.5" fill="white" text-anchor="middle" font-family="Arial">S.Leone/Lib.</text>
    <!-- Ivory Coast -->
    <polygon points="115,270 165,265 185,275 188,300 175,320 148,328 118,315 115,295" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="150" y="298" font-size="6.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Ivory Coast</text>
    <!-- Ghana -->
    <polygon points="188,275 220,270 235,280 238,308 225,328 200,332 178,322 175,300" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="207" y="303" font-size="6.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Ghana</text>
    <!-- Togo & Benin -->
    <polygon points="238,278 260,275 268,285 265,310 255,325 240,328 235,310" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="252" y="303" font-size="5" fill="white" text-anchor="middle" font-family="Arial">Togo/Benin</text>
    <!-- Burkina Faso -->
    <polygon points="165,265 230,250 265,255 268,278 240,280 188,275 170,268" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="216" y="265" font-size="6.5" fill="white" text-anchor="middle" font-family="Arial">Burkina Faso</text>
    <!-- Nigeria -->
    <polygon points="268,255 345,248 370,258 375,290 365,325 335,345 300,348 270,335 258,308 262,278 268,265" fill="#c9a84c" stroke="white" stroke-width="0.7"/>
    <text x="315" y="302" font-size="8" fill="white" text-anchor="middle" font-family="Arial" font-weight="700">Nigeria</text>

    <!-- CENTRAL AFRICA — Red/Coral #c0392b -->
    <!-- Cameroon -->
    <polygon points="345,248 385,240 400,255 405,285 390,310 365,325 345,310 338,285 342,262" fill="#c0392b" stroke="white" stroke-width="0.7"/>
    <text x="372" y="284" font-size="6.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Cameroon</text>
    <!-- Chad -->
    <polygon points="355,155 415,150 440,160 445,195 430,225 415,240 385,240 370,220 365,185 360,165" fill="#c0392b" stroke="white" stroke-width="0.7"/>
    <text x="400" y="195" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Chad</text>
    <!-- Central African Republic -->
    <polygon points="405,255 440,248 480,252 490,275 480,298 450,308 415,305 400,285" fill="#c0392b" stroke="white" stroke-width="0.7"/>
    <text x="445" y="278" font-size="6" fill="white" text-anchor="middle" font-family="Arial">C.A.R.</text>
    <!-- Gabon & Congo-Brazzaville -->
    <polygon points="390,312 425,308 445,318 448,345 432,360 405,362 385,345 382,325" fill="#c0392b" stroke="white" stroke-width="0.7"/>
    <text x="415" y="338" font-size="5.5" fill="white" text-anchor="middle" font-family="Arial">Gabon/Congo</text>
    <!-- DRC -->
    <polygon points="450,308 495,300 530,310 545,335 548,375 535,405 510,420 475,425 448,415 430,390 425,360 448,345 448,320" fill="#c0392b" stroke="white" stroke-width="0.7"/>
    <text x="490" y="365" font-size="8" fill="white" text-anchor="middle" font-family="Arial" font-weight="700">DR Congo</text>
    <!-- South Sudan -->
    <polygon points="440,240 480,248 510,255 520,280 505,300 480,305 452,298 438,275 430,255" fill="#c0392b" stroke="white" stroke-width="0.7"/>
    <text x="477" y="275" font-size="6" fill="white" text-anchor="middle" font-family="Arial">S. Sudan</text>

    <!-- EAST AFRICA — Green #2d6b45 -->
    <!-- Ethiopia -->
    <polygon points="510,155 555,148 590,162 600,192 590,220 562,235 530,238 510,228 505,200 505,175" fill="#2d6b45" stroke="white" stroke-width="0.7"/>
    <text x="550" y="193" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Ethiopia</text>
    <!-- Eritrea & Djibouti -->
    <polygon points="510,148 555,140 565,152 555,162 510,162" fill="#2d6b45" stroke="white" stroke-width="0.7"/>
    <text x="535" y="153" font-size="5.5" fill="white" text-anchor="middle" font-family="Arial">Eritrea</text>
    <!-- Somalia -->
    <polygon points="562,235 595,220 625,205 645,228 640,265 618,300 595,310 570,298 555,270 555,248" fill="#2d6b45" stroke="white" stroke-width="0.7"/>
    <text x="605" y="263" font-size="7" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Somalia</text>
    <!-- Uganda -->
    <polygon points="520,285 548,278 560,290 558,315 540,328 518,325 510,308 512,292" fill="#2d6b45" stroke="white" stroke-width="0.7"/>
    <text x="535" y="307" font-size="6.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Uganda</text>
    <!-- Kenya -->
    <polygon points="560,245 598,238 620,252 625,280 615,308 590,320 565,315 555,298 555,270" fill="#2d6b45" stroke="white" stroke-width="0.7"/>
    <text x="590" y="282" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="700">Kenya</text>
    <!-- Rwanda & Burundi -->
    <polygon points="548,318 565,314 570,328 560,340 545,338 542,325" fill="#2d6b45" stroke="white" stroke-width="0.7"/>
    <text x="556" y="330" font-size="5" fill="white" text-anchor="middle" font-family="Arial">Rwa/Bur</text>
    <!-- Tanzania -->
    <polygon points="558,340 590,325 625,332 638,360 632,395 610,415 580,420 553,408 542,380 545,355" fill="#2d6b45" stroke="white" stroke-width="0.7"/>
    <text x="590" y="378" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Tanzania</text>
    <!-- Mozambique -->
    <polygon points="548,430 580,425 605,440 610,470 598,510 575,530 548,525 530,505 530,468 540,445" fill="#2d6b45" stroke="white" stroke-width="0.7"/>
    <text x="572" y="480" font-size="6.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Mozambique</text>
    <!-- Madagascar -->
    <polygon points="640,415 665,408 680,425 685,465 672,500 655,510 638,498 630,462 630,432" fill="#2d6b45" stroke="white" stroke-width="0.7"/>
    <text x="657" y="460" font-size="7" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Madagascar</text>

    <!-- SOUTHERN AFRICA — Blue #1a5a8a -->
    <!-- Angola -->
    <polygon points="418,365 450,360 480,365 500,388 505,425 495,455 468,465 440,458 418,432 412,400 415,378" fill="#1a5a8a" stroke="white" stroke-width="0.7"/>
    <text x="458" y="415" font-size="7.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Angola</text>
    <!-- Zambia -->
    <polygon points="505,422 535,415 548,428 545,460 530,478 505,485 478,478 468,458 480,435 500,428" fill="#1a5a8a" stroke="white" stroke-width="0.7"/>
    <text x="508" y="452" font-size="7" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Zambia</text>
    <!-- Zimbabwe -->
    <polygon points="530,480 555,475 572,488 570,512 552,525 530,522 515,508 515,490" fill="#1a5a8a" stroke="white" stroke-width="0.7"/>
    <text x="543" y="503" font-size="6.5" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Zimbabwe</text>
    <!-- Namibia -->
    <polygon points="415,458 445,460 470,468 488,490 490,525 478,555 450,570 418,565 398,540 392,508 400,478" fill="#1a5a8a" stroke="white" stroke-width="0.7"/>
    <text x="443" y="515" font-size="7" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Namibia</text>
    <!-- Botswana -->
    <polygon points="468,488 495,485 515,495 525,518 518,545 498,558 472,558 452,542 450,515 458,498" fill="#1a5a8a" stroke="white" stroke-width="0.7"/>
    <text x="488" y="525" font-size="7" fill="white" text-anchor="middle" font-family="Arial" font-weight="600">Botswana</text>
    <!-- South Africa -->
    <polygon points="418,568 452,558 475,560 500,562 525,548 545,558 552,582 540,615 510,640 478,648 450,645 422,625 400,600 395,572" fill="#1a5a8a" stroke="white" stroke-width="0.7"/>
    <text x="476" y="605" font-size="8" fill="white" text-anchor="middle" font-family="Arial" font-weight="700">South Africa</text>
    <!-- Lesotho -->
    <polygon points="478,602 495,598 503,610 495,622 478,622 470,610" fill="#2d6b85" stroke="white" stroke-width="0.7"/>
    <text x="487" y="613" font-size="4.5" fill="white" text-anchor="middle" font-family="Arial">Lesotho</text>

    <!-- LEGEND -->
    <rect x="20" y="740" width="740" height="68" rx="8" fill="white" stroke="#ddd" stroke-width="0.5"/>
    <text x="380" y="758" font-size="9" fill="#444" text-anchor="middle" font-family="Arial" font-weight="700">REGIONS</text>
    <!-- North -->
    <rect x="30" y="765" width="12" height="12" rx="2" fill="#7b3fa0"/>
    <text x="46" y="775" font-size="8" fill="#444" font-family="Arial">North Africa</text>
    <!-- West -->
    <rect x="140" y="765" width="12" height="12" rx="2" fill="#c9a84c"/>
    <text x="156" y="775" font-size="8" fill="#444" font-family="Arial">West Africa</text>
    <!-- Central -->
    <rect x="250" y="765" width="12" height="12" rx="2" fill="#c0392b"/>
    <text x="266" y="775" font-size="8" fill="#444" font-family="Arial">Central Africa</text>
    <!-- East -->
    <rect x="370" y="765" width="12" height="12" rx="2" fill="#2d6b45"/>
    <text x="386" y="775" font-size="8" fill="#444" font-family="Arial">East Africa</text>
    <!-- South -->
    <rect x="470" y="765" width="12" height="12" rx="2" fill="#1a5a8a"/>
    <text x="486" y="775" font-size="8" fill="#444" font-family="Arial">Southern Africa</text>
    <!-- Madagascar note -->
    <text x="590" y="775" font-size="7.5" fill="#888" font-family="Arial" font-style="italic">Madg. = East Africa</text>
    <!-- Ocean labels -->
    <text x="48" y="450" font-size="9" fill="#9ab8d4" font-family="Arial" font-style="italic" transform="rotate(-75,48,450)">Atlantic Ocean</text>
    <text x="700" y="450" font-size="9" fill="#9ab8d4" font-family="Arial" font-style="italic" transform="rotate(75,700,450)">Indian Ocean</text>
    <text x="390" y="55" font-size="9" fill="#9ab8d4" font-family="Arial" font-style="italic" text-anchor="middle">Mediterranean Sea</text>
  </svg>
</div>`;
...
function renderCallout(s) {
  ...
  return `<div class="${cls}">
    <span style="font-size:16px;flex-shrink:0;">${s.icon || icon}</span>
